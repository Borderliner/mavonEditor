...
import help_fa_IR from "./lang/fa-IR/help_fa.md";
...
import words_fa_IR from "./lang/fa-IR/words_fa.json";
...
export const CONFIG = {
  ...
  "words_fa-IR": words_fa_IR,
  words_en: words_en,
  words_fr: words_fr,
  words_ru: words_ru,
  words_de: words_de,
  words_ja: words_ja,
  langList: ["en", "zh-CN", "zh-TW", "fr", "fa-IR", "pt-BR", "ru", "de", "ja"],
  toolbars: {
    bold: true,
    italic: true,
    header: true,
